...
$("#faqUpdate").click(function () {
    ...
    if (flag) {
        $.ajax({
            type: "POST",
            url: appUrl + "/admin/faq/" + $.trim($("#id").val()),
            data: new FormData($("#faqForm")[0]),
            mimeType: "multipart/form-data",
            contentType: false,
            cache: false,
...
$("#discountForm").on("click", "#discountInsert", function () {
    removeError();
    var flag = true;
    var base_discount = $.trim($("#base_discount").val());
    var incremental_discount = $.trim($("#incremental_discount").val());
    ...
    if (flag) {
        $.ajax({
            ...
            processData: false,
            beforeSend: function () {
                dataSaving("#discountInsert", true);
            },
            success: function (data) {
                var obj = JSON.parse(data);
                if (obj.res == "invalid") {
                    ...
                    dataSaving("#discountInsert", false);
                    notify("error", "Please fill all mandatory fields.");
                } else if (obj.res == "error") {
                    notify(obj.res, obj.msg);
                    dataSaving("#discountInsert", false);
...
$("#discountForm").on("click", "#discountUpdate", function () {
    removeError();
    var flag = true;
    var base_discount = $.trim($("#base_discount").val());
    var incremental_discount = $.trim($("#incremental_discount").val());
    ...
    if (flag) {
        $.ajax({
            type: "POST",
            url: appUrl + "/admin/discount/" + $.trim($("#id").val()),
            data: new FormData($("#discountForm")[0]),
            mimeType: "multipart/form-data",
            contentType: false,
            cache: false,
            processData: false,
            beforeSend: function () {
                dataSaving("#discountUpdate", true);
            },
            success: function (data) {
                var obj = JSON.parse(data);
                if (obj.res == "invalid") {
                    ...
                    notify("error", "Please fill all mandatory fields.");
                    dataSaving("#discountUpdate", false);
                } else if (obj.res == "error") {
                    notify(obj.res, obj.msg);
                    dataSaving("#discountUpdate", false);
                } else if (obj.res == "success") {
...
$("#pageForm").on("click", "#pageInsert", function () {
    removeError();
    var editor = tinymce.get("content").getContent();
    var flag = true;
    var title = $.trim($("#title").val());
    var pageTitle = $.trim($("#pageTitle").val());

    var content = $.trim($("#content").val(editor));
    console.log(content);
...
$("#pressReleaseInsert").click(function () {
    removeError();
    var flag = true;
    var title = $.trim($("#title").val());
    var image = $.trim($("#image").val());
    ...
    if (date == "") {
        ...
        $("[for=date] span.error").html("Please enter date");
        flag = false;
    }
    if (url == "") {
        $("#url").parents(".form-group").addClass("has-error");
    ...
    if (flag) {
        $.ajax({
            type: "POST",
            url: appUrl + "/admin/press-release",
            data: new FormData($("#pressReleaseForm")[0]),
            mimeType: "multipart/form-data",
            contentType: false,
            cache: false,
            processData: false,
            beforeSend: function () {
                dataSaving("#pressReleaseInsert", true);
            },
            success: function (data) {
                var obj = JSON.parse(data);
                if (obj.res == "invalid") {
                    ...
                    dataSaving("#pressReleaseInsert", false);
                    notify("error", "Please fill all mandatory fields.");
                } else if (obj.res == "success") {
                    $("#pressReleaseForm").trigger("reset");
                    $(".form-group").removeClass("has-error");
                    $("span.error").html("");
                    dataSaving("#pressReleaseInsert", false);
                    notify(obj.res, obj.msg);
...
$("#pressReleaseUpdate").click(function () {
    removeError();
    var flag = true;
    var title = $.trim($("#title").val());
    var image = $.trim($("#image").val());
    ...
    if (flag) {
        $.ajax({
            type: "POST",
            url: appUrl + "/admin/press-release/" + $.trim($("#id").val()),
            data: new FormData($("#pressReleaseForm")[0]),
            mimeType: "multipart/form-data",
            contentType: false,
            cache: false,
            processData: false,
            beforeSend: function () {
                dataSaving("#pressReleaseUpdate", true);
            },
            success: function (data) {
                console.log(data);
                var obj = JSON.parse(data);
                if (obj.res == "invalid") {
                    ...
                    notify("error", "Please fill all mandatory fields.");
                    dataSaving("#pressReleaseUpdate", false);
                } else if (obj.res == "success") {
                    notify(obj.res, obj.msg);
                    dataSaving("#pressReleaseUpdate", false);
                    setTimeout(function () {
...
$("#aboutForm").on("click", "#aboutUpdate", function () {
    removeError();
    var flag = true;
    var title = $("#title").val();
    var image = $("#image").val();
    var description = $("#description").val();
    var om_title = $("#om_title").val();
    var om_image = $("#om_image").val();
    var om_description = $("#om_description").val();
    var ov_title = $("#ov_title").val();
    var ov_image = $("#ov_image").val();
    var ov_description = $("#ov_description").val();
    var qa_title = $("#qa_title").val();
    var qa_image = $("#qa_image").val();
    var qa_description = $("#qa_description").val();
    var ni_title = $("#ni_title").val();
    var ni_image = $("#ni_image").val();
    var ni_description = $("#ni_description").val();
    ...
    if (om_title == "") {
        $("#om_title").parents(".form-group").addClass("has-error");
        $("[for=om_title] span.error").html("Please enter title");
        flag = false;
    }
    // if(om_image=='')
    // {
    //     $("#om_image").parents(".form-group").addClass("has-error");
    //     $("[for=om_image] span.error").html('Please select image');
    //     flag = false;
    // }
    if (om_description == "") {
        $("#om_description").parents(".form-group").addClass("has-error");
        $("[for=om_description] span.error").html("Please enter description");
        flag = false;
    }
    if (ov_title == "") {
        $("#ov_title").parents(".form-group").addClass("has-error");
        $("[for=ov_title] span.error").html("Please enter title");
        flag = false;
    }
    // if(ov_image=='')
    // {
    //     $("#ov_image").parents(".form-group").addClass("has-error");
    //     $("[for=ov_image] span.error").html('Please select image');
    //     flag = false;
    // }
    if (ov_description == "") {
        $("#ov_description").parents(".form-group").addClass("has-error");
        $("[for=ov_description] span.error").html("Please enter description");
        flag = false;
    }
    if (qa_title == "") {
        $("#qa_title").parents(".form-group").addClass("has-error");
        $("[for=qa_title] span.error").html("Please enter title");
        flag = false;
    }
    // if(qa_image=='')
    // {
    //     $("#qa_image").parents(".form-group").addClass("has-error");
    //     $("[for=qa_image] span.error").html('Please select image');
    //     flag = false;
    // }
    if (qa_description == "") {
        $("#qa_description").parents(".form-group").addClass("has-error");
        $("[for=qa_description] span.error").html("Please enter description");
        flag = false;
    }
    if (ni_title == "") {
        $("#ni_title").parents(".form-group").addClass("has-error");
        $("[for=ni_title] span.error").html("Please enter title");
        flag = false;
    }
    // if(ni_image=='')
    // {
    //     $("#ni_image").parents(".form-group").addClass("has-error");
    //     $("[for=ni_image] span.error").html('Please select image');
    //     flag = false;
    // }
    if (ni_description == "") {
        $("#ni_description").parents(".form-group").addClass("has-error");
        $("[for=ni_description] span.error").html("Please enter description");
        flag = false;
    }
    if (m_title == "") {
        $("#m_title").parents(".form-group").addClass("has-error");
        $("[for=m_title] span.error").html("Please enter title");
        flag = false;
    }
    // if(m_image=='')
    // {
    //     $("#m_image").parents(".form-group").addClass("has-error");
    //     $("[for=m_image] span.error").html('Please select image');
    //     flag = false;
    // }
    if (m_video == "") {
        $("#m_video").parents(".form-group").addClass("has-error");
        $("[for=m_video] span.error").html("Please enter video code");
        flag = false;
    }
    if (m_description == "") {
        $("#m_description").parents(".form-group").addClass("has-error");
        $("[for=m_description] span.error").html("Please enter description");
        flag = false;
    }
    if (flag) {
        $.ajax({
            type: "POST",
            url: appUrl + "/admin/about/" + $.trim($("#id").val()),
