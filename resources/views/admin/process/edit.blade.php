                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-addon" data-toggle="popover" data-trigger="hover" data-html="true" data-placement="left" data-content="<img src='{{ asset('storage/process/'.$data->image) }}' class='img-150w' />">
                                            <img src="{{ asset('storage/process/'.$data->image) }}" style="width: 24px; height: 20px;" />
                                        </span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-xs-12 text-center">
                                <div class="form-group">
                                    ...
                                    <button type="submit" name="processUpdate" id="processUpdate" class="btn btn-default">
                                        Save
                                    </button>
                                </div>
                            </div>
