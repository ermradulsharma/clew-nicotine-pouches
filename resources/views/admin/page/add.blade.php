                ...
                <div class="panel-body">
                    <form class="form" name="pageForm" id="pageForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="pageTitle">Page Title <span class="text-danger">*</span><span class="error"></span></label>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="pageDescription">Page Description <span class="text-danger">*</span><span class="error"></span></label>
                                <textarea class="form-control" name="pageDescription" id="pageDescription"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                <label for="pageKeywords">Page Keywords <span class="text-danger">*</span><span class="error"></span></label>
                        ...
                        <div class="col-sm-12 col-md-12 col-xs-12 text-center">
                            <div class="form-group">
                                @csrf
                                <button type="submit" name="pageInsert" id="pageInsert" class="btn btn-default">
                                    Save
                                </button>
                            </div>
                        </div>
