                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" name="strengths[]" value="{{ $strength->id }}" /> {{ $strength->title }} &nbsp; &nbsp;
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="base_discount" id="base_discount" class="form-control" value="0" onkeypress=" return decimalsonly(event);" maxlength="2" />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label for="incremental_discount">Incremental Discount <span class="text-danger">*</span><span class="error"></span></label>
                                    <input type="text" name="incremental_discount" id="incremental_discount" class="form-control" value="0" onkeypress=" return decimalsonly(event);" maxlength="2" />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label for="max_discount">Max Discount <span class="text-danger">*</span><span class="error"></span></label>
                                    <input type="text" name="max_discount" id="max_discount" class="form-control" value="0" onkeypress=" return decimalsonly(event);" maxlength="2" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="pageTitle" id="pageTitle" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="pageKeywords" id="pageKeywords"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-xs-12 text-center">
                                <div class="form-group">
                                    @csrf
                                    <button type="submit" name="productInsert" id="productInsert" class="btn btn-default">
                                        Save
                                    </button>
                                </div>
                            </div>
