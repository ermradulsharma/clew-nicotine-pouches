        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="search-form">
                    <a href="{{ route('admin.about.edit', 1) }}" class="btn btn-default btn-sm pull-right">Edit</a>
                </div>
                <!-- OVERVIEW -->
                    ...
                    <div class="panel-body">
                        <form class="form" name="aboutForm" id="aboutForm" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="file" name="image" id="image" class="form-control" accept="image/*" disabled />
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="om_title" id="om_title" value="{{ $data->om_title }}" class="form-control" disabled />
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="file" name="om_image" id="om_image" class="form-control" accept="image/*" disabled />
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="om_description" id="om_description" disabled>{{ $data->om_description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ov_title" id="ov_title" value="{{ $data->ov_title }}" class="form-control" disabled />
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="file" name="ov_image" id="ov_image" class="form-control" accept="image/*" disabled />
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="ov_description" id="ov_description" disabled>{{ $data->ov_description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="qa_title" id="qa_title" value="{{ $data->qa_title }}" class="form-control" disabled />
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="file" name="qa_image" id="qa_image" class="form-control" accept="image/*" disabled />
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="qa_description" id="qa_description" disabled>{{ $data->qa_description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ni_title" id="ni_title" value="{{ $data->ni_title }}" class="form-control" disabled />
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="file" name="ni_image" id="ni_image" class="form-control" accept="image/*" disabled />
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="ni_description" id="ni_description" disabled>{{ $data->ni_description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="m_title" id="m_title" value="{{ $data->m_title }}" class="form-control" disabled />
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="file" name="m_image" id="m_image" class="form-control" accept="image/*" disabled />
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="m_video" id="m_video" value="{{ $data->m_video }}" class="form-control" disabled />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="m_description" id="m_description" disabled>{{ $data->m_description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-12 col-xs-12 text-center">
                                <div class="form-group">
                                    <a href="{{ route('admin.about.edit', 1) }}" class="btn btn-default">Edit</a>
                                </div>
                            </div>
                        </form>
                    </div>
