        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-headline">
                ...
                <div class="panel-body">
                    <form class="form" name="storeForm" id="storeForm" method="post" enctype="multipart/form-data">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-xs-12 text-center">
                                <div class="form-group">
                                    @csrf
                                    <button type="submit" name="storeInsert" id="storeInsert" class="btn btn-default">
                                        Save
                                    </button>
                                </div>
                            </div>
