    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="search-form">
                ...
                <a href="{{ route('admin.website.edit', 1) }}" class="btn btn-default btn-sm pull-right">Edit</a>
                    ...
                    <form class="form" name="websiteForm" id="websiteForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="file" name="favicon" id="favicon" class="form-control" accept="image/*" disabled />
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <textarea name="disclaimer" id="disclaimer" class="form-control" disabled>{{ $data->disclaimer }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="pageTitle" id="pageTitle" class="form-control" disabled>{{ $data->pageTitle }}</textarea>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="pageDescription" id="pageDescription" disabled>{{ $data->pageDescription }}</textarea>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="pageKeywords" id="pageKeywords" disabled>{{ $data->pageKeywords }}</textarea>
                        ...
                        <div class="col-sm-12 col-md-12 col-xs-12 text-center">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('admin.website.edit', 1) }}" class="btn btn-default">Edit</a>
